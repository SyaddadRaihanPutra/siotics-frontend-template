                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#" method="">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="email-address-icon"
                                        ...
                                        placeholder="name@siotics.org" required>
                                </div>
                            </div>
                            <div>
                                <label for="password"
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#"
                                    class="text-sm font-semibold text-blue-600 hover:underline dark:text-blue-500">Forgot
                                    password?</a>
                            </div>
                            <button type="submit"
                                class="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign
                                in</button>
                            ...
                            <p class="text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                                Don't have an account? <RouterLink to="/signup"
                                    class="font-semibold text-blue-600 hover:underline dark:text-blue-500">Sign up
                                </RouterLink>
                            </p>
                        </form>
                    </div>
